...
function PrivacyPolicy({ }: Props) {
    ...
    return (
        <div className="bg-white lg:py-12 lg:flex flex-col lg:justify-center lg:items-center h-max">

            <div className="bg-light w-full px-[5.5%]  flex py-6 items-center">
                <Typography fontVariation="bold" className="text-gray text-lg">Politique de confidentialité</Typography>
            </div>

            <div className="w-full px-[5.5%] h-max flex flex-col bg-white py-6 ">
                {/* <div className="flex flex-col">
                    <Typography className="mt-2 text-dark bg-yellow-600 dark:text-gray-400 flex-col gap-y-3 leading-loose text-sm">
                ...
                <>
                    <h3 className="mb-0" style={{ marginTop: "0.2em!important" }}>
                    ...
                    <p>
                        ...
                        <span style={{ color: "#8351f9" }}>[Company Name]</span> (doing business as{" "}
                        <span style={{ color: "#8351f9" }}>[Company Short Name]</span>) (“
                        <strong>Company</strong>,” “<strong>we</strong>,” “<strong>us</strong>,” or
                        “<strong>our</strong>“), describes how and why we might collect, store, use,
                        and/or share (“<strong>process</strong>“) your information when you use our
                        services (“<strong>Services</strong>“), such as when you:
                    </p>
                    <ul>
                        <li>
                            Visit our website at{" "}
                            <span style={{ color: "#8351f9" }}>[Website URL]</span>, or any website of
                            ours that links to this privacy notice
                        </li>
                        <li>
                            <span style={{ color: "#8351f9" }}>
                                [Download and use our application(s), such as our mobile application —
                                [Mobile App Name], our Facebook application — [Facebook App Name], or
                    ...
                    <p>
                        ...
                        <span style={{ color: "#8351f9" }}>[Company Name]</span> and the Services,
                    ...
                    <p>
                        <strong>Do you receive any information from third parties?</strong> We may
                    ...
                    <p>
                        ...
                        <span style={{ color: "#8351f9" }}>[DSAR Form URL]</span>, or by contacting
                    ...
                    <p>
                        ...
                        <span style={{ color: "#8351f9" }}>[register on the Services,]</span>{" "}
                    ...
                    <ul>
                        <li>
                            <span style={{ color: "#8351f9" }}>[Personal Info Collected]</span>
                        </li>
                        <li>
                            <span style={{ color: "#8351f9" }}>[Personal Info Collected]</span>
                        </li>
                    ...
                    <p>
                        ...
                        <span style={{ color: "#8351f9" }}>
                            [We do not process sensitive information. / When necessary, with your
                    ...
                    <ul>
                        <li>
                            <span style={{ color: "#8351f9" }}>[Sensitive Info Collected]</span>
                        </li>
                        <li>
                            <span style={{ color: "#8351f9" }}>[Sensitive Info Collected]</span>
                        </li>
                    ...
                    <p>
                        ...
                        payment if you make purchases, such as your payment instrument number (such
                        as a credit card number), and the security code associated with your payment
                        instrument. All payment data is stored by{" "}
                        <span style={{ color: "#8351f9" }}>[Vendor Name]</span>. You may find their
                        privacy notice link(s) here:{" "}
                        <span style={{ color: "#8351f9" }}>[Vendor Privacy Policy]</span>.
                    </p>
                    <p>
                        ...
                        section called “<em>HOW DO WE HANDLE YOUR SOCIAL LOGINS?</em>” below.
                    </p>
                    <p>
                        <span style={{ color: "#8351f9" }}>
                            [<strong>Application Data.</strong> If you use our application(s), we also
                            may collect the following information if you choose to provide us with
                    ...
                    <ul>
                        <li>
                            <em>
                                <span style={{ color: "#8351f9" }}>Geolocation Information.</span>
                            </em>{" "}
                            <span style={{ color: "#8351f9" }}>
                                We may request access or permission to track location-based information
                                from your mobile device, either continuously or while you are using our
                        ...
                        <li>
                            <em>
                                <span style={{ color: "#8351f9" }}>Mobile Device Access.</span>
                            </em>{" "}
                            <span style={{ color: "#8351f9" }}>
                                We may request access or permission to certain features from your mobile
                                device, including your mobile device’s bluetooth, calendar, camera, own,
                                and other features. If you wish to change our access or permissions, you
                                may do so in your device’s settings.
                            </span>
                        </li>
                        <li>
                            <em>
                                <span style={{ color: "#8351f9" }}>Mobile Device Data.</span>
                            </em>{" "}
                            <span style={{ color: "#8351f9" }}>
                                We automatically collect device information (such as your mobile device
                                ID, model, and manufacturer), operating system, version information and
                        ...
                        <li>
                            <em>
                                <span style={{ color: "#8351f9" }}>Push Notifications.</span>
                            </em>{" "}
                            <span style={{ color: "#8351f9" }}>
                    ...
                    <p>
                        ...
                        affiliate programs, data providers, social media platforms, and from other
                        ...
                        promotion. If you interact with us on a social media platform using your
                        social media account (e.g., Facebook or Twitter), we receive personal
                        information about you such as your name, email address, and gender. Any
                        personal information that we collect from your social media account depends
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            your information if you choose to use any of our offerings that allow for
                        ...
                        <li>
                            ...
                            “<em>WHAT ARE YOUR PRIVACY RIGHTS?</em>” below).
                        </li>
                        <li>
                    ...
                    <p>
                        ...
                        notice, since we determine the means and/or purposes of the data processing
                        we perform. This privacy notice does not apply to the personal information
                        we process as a “data processor” on behalf of our customers. In those
                        situations, the customer that we provide services to and with whom we have
                        entered into a data processing agreement is the “data controller”
                    ...
                    <p>
                        ...
                        on our behalf and to retain it for the period we instruct. The categories of
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            Places API). To find out more about Google’s Privacy Policy, please refer
                            to this{" "}
                            <a
                            ...
                            <span style={{ color: "#8351f9" }}>[List of Information Collected]</span>,
                            and other similar information. A full list of what we use information for
                            can be found in this section and in the previous section titled “
                            <em>HOW DO WE PROCESS YOUR INFORMATION?</em>”. [We obtain and store on
                            your device (‘cache’) your location for{" "}
                            <span style={{ color: "#8351f9" }}>[#]</span> months. You may revoke your
                            consent anytime by contacting us at the contact details provided at the
                            end of this document. The Google Maps Platform APIs that we use store and
                            ...
                            Cookie Notice, which can be found at this link:{" "}
                            <span style={{ color: "#8351f9" }}>[Cookie Notice URL]</span>.
                        </li>
                        <li>
                        ...
                        <li>
                            <strong>Offer Wall.</strong> Our application(s) may display a third-party
                            hosted “offer wall.” Such an offer wall allows third-party advertisers to
                            ...
                            may appear in our application(s) and be displayed to you based on certain
                            data, such as your geographic area or demographic information. When you
                            click on an offer wall, you will be brought to an external website
                            ...
                            provider in order to prevent fraud and properly credit your account with
                            the relevant reward.
                        </li>
                    </ul>
                    ...
                    <p>
                        The Services,{" "}
                        <span style={{ color: "#8351f9" }}>[including our offer wall]</span>, may
                        link to third-party websites, online services, or mobile applications and/or
                        contain advertisements from third parties that are not affiliated with us
                    ...
                    <p>
                        ...
                        on such a social media platform. If you log in using Facebook, we may also
                        request access to other permissions related to your account, such as your
                        friends, check-ins, and likes, and you may choose to grant or deny us access
                    ...
                    <p>
                        ...
                        <span style={{ color: "#8351f9" }}>
                            [Countries where Server is Located]
                        </span>
                        ...
                        <em>WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</em>” above),
                        in{" "}
                        <span style={{ color: "#8351f9" }}>
                            [Countries where Third-Party Servers are Located]
                        </span>
                        , and other countries.
                    </p>
                    <p>
                        ...
                        other similar laws as comprehensive as those in your country. However, we
                    ...
                    <p>
                        ...
                        available here:{" "}
                        <span style={{ color: "#8351f9" }}>[Standard Contractual Clauses URL]</span>
                    ...
                    <p>
                        ...
                        implemented by <span style={{ color: "#8351f9" }}>[Company Name]</span>. Our
                        BCRs have been recognized by EEA and UK data protection authorities as
                        providing an adequate level of protection to the personal information we
                        process internationally. You can find a copy of our BCRs here:{" "}
                        <span style={{ color: "#8351f9" }}>[BCRs URL]</span>.
                    </p>
                    <p>
                        <span style={{ color: "#8351f9" }}>[EU-US]</span> and{" "}
                        <span style={{ color: "#8351f9" }}>[Swiss-US]</span> Privacy Shield
                        Framework<span style={{ color: "#8351f9" }}>[s]</span>
                    </p>
                    <p>
                        <span style={{ color: "#8351f9" }}>[Company Name]</span> and the following
                        entities and subsidiaries:{" "}
                        <span style={{ color: "#8351f9" }}>[List of Entities/Subsidiaries]</span>{" "}
                        comply with the <span style={{ color: "#8351f9" }}>[EU-US]</span> and{" "}
                        <span style={{ color: "#8351f9" }}>[Swiss-US]</span> Privacy Shield
                        Framework<span style={{ color: "#8351f9" }}>[s]</span> as set forth by the
                        US Department of Commerce regarding the collection, use, and retention of
                        personal information transferred from{" "}
                        <span style={{ color: "#8351f9" }}>[the European Union (EU)]</span>,{" "}
                        <span style={{ color: "#8351f9" }}>[the UK]</span>, and{" "}
                        <span style={{ color: "#8351f9" }}>[Switzerland]</span> to the United
                        States. Although Privacy Shield is no longer considered a valid transfer
                        mechanism for the purposes of <span style={{ color: "#8351f9" }}>[EU]</span>{" "}
                        and <span style={{ color: "#8351f9" }}>[Swiss]</span> data protection law,
                        in light of the judgment of the Court of Justice of the European Union in
                        Case C-311/18 and opinion of the Federal Data Protection and Information
                        Commissioner of Switzerland dated 8 September 2020,{" "}
                        <span style={{ color: "#8351f9" }}>[Company Name]</span> will continue to
                        comply with the principles of the{" "}
                        <span style={{ color: "#8351f9" }}>[EU-US]</span> and{" "}
                        <span style={{ color: "#8351f9" }}>[Swiss-US]</span> Privacy Shield
                        Framework<span style={{ color: "#8351f9" }}>[s]</span>. To learn more about
                        the Privacy Shield program, please visit{" "}
                        <a
                        ...
                        <span style={{ color: "#8351f9" }}>[Privacy Shield Certification URL]</span>
                        .
                    </p>
                    <p>
                        <span style={{ color: "#8351f9" }}>[Company Name]</span> adheres to and
                        complies with the Privacy Shield Principles when processing personal
                        information from <span style={{ color: "#8351f9" }}>[the EU]</span>,{" "}
                        <span style={{ color: "#8351f9" }}>[UK]</span>, or{" "}
                        <span style={{ color: "#8351f9" }}>[Switzerland]</span>. If we have received
                        your personal information in the United States and subsequently transfer
                        that information to a third party acting as our agent, and such third party
                        agent processes your personal information in a manner inconsistent with the
                        Privacy Shield Principles, we will remain liable unless we can prove we are
                    ...
                    <p>
                        ...
                        Privacy Shield Framework<span style={{ color: "#8351f9" }}>[s]</span>,{" "}
                        <span style={{ color: "#8351f9" }}>[Company Name]</span> is subject to the
                        investigatory and enforcement powers of the US Federal Trade Commission
                    ...
                    <p>
                        ...
                        <span style={{ color: "#8351f9" }}>[Company Name]</span>’s Privacy Shield
                        certification, please write to us at the contact details below. We commit to
                        resolving any complaints or disputes about our collection and use of your
                        personal information under the Privacy Shield.{" "}
                        <span style={{ color: "#8351f9" }}>
                            [However, if you have an unresolved complaint in connection with our
                            certification, we commit to cooperating with the panel established by [the
                            EU data protection authorities (DPAs)], [the UK Information Commissioner],
                            and [the Swiss Federal Data Protection and Information Commissioner], as
                            applicable, and to comply with the advice given by them in respect of the
                            complaint. Click here for a{" "}
                            <a
                            ...
                            . / However, if you have an unresolved complaint in connection with our
                            certification, you may contact our independent dispute resolution provider
                            based in the [EU/United States], [Dispute Resolution Provider Name].
                            Please visit [Dispute Resolution Provider URL] for more information or to
                            file a complaint. These services are provided to you free of charge.]
                        </span>
                    </p>
                    <p>
                        In limited situations, <span style={{ color: "#8351f9" }}>[EU]</span>,{" "}
                        <span style={{ color: "#8351f9" }}>[UK]</span>, and{" "}
                        <span style={{ color: "#8351f9" }}>[Swiss]</span> individuals may seek
                        redress from the Privacy Shield Panel, a binding arbitration mechanism.
                    </p>
                    <p>
                        Please be sure to review the following sections of this Privacy Notice for
                        additional details relevant to{" "}
                        <span style={{ color: "#8351f9" }}>[Company Name]</span>’s participation in
                        the <span style={{ color: "#8351f9" }}>[EU-US]</span> and{" "}
                        <span style={{ color: "#8351f9" }}>[Swiss-US]</span> Privacy Shield:
                    </p>
                    <ul>
                        <li>
                            <em>WHAT INFORMATION DO WE COLLECT?</em> To learn more about the types of
                            personal data{" "}
                            <em>
                                <span style={{ color: "#8351f9" }}>[Company Name]</span>
                            </em>{" "}
                            collects.
                        </li>
                        <li>
                            <em>HOW DO WE PROCESS YOUR INFORMATION?</em> To learn more about the
                            purposes for which{" "}
                            <em>
                                <span style={{ color: "#8351f9" }}>[Company Name]</span>
                            </em>{" "}
                        ...
                        <li>
                            <em>WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</em> To
                            learn more about the type or identity of third parties to which{" "}
                            <em>
                                <span style={{ color: "#8351f9" }}>[Company Name]</span>
                            </em>{" "}
                            discloses personal information, and the purposes for which we do so.
                        </li>
                        <li>
                            <em>WHAT ARE YOUR PRIVACY RIGHTS?</em> To learn more about the right of
                            individuals to access their personal data.
                        </li>
                    </ul>
                    ...
                    <p>
                        ...
                        <span style={{ color: "#8351f9" }}>
                            [the period of time in which users have an account with us / [#] months
                            past the termination of the user’s account / [#] months past the start of
                    ...
                    <p>
                        ...
                        provided in the section “<em>HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</em>”
                    ...
                    <p>
                        ...
                        <span style={{ color: "#8351f9" }}>[Other]</span> or by contacting us using
                        the details provided in the section “
                        <em>HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</em>” below. You will then be
                    ...
                    <p>
                        ...
                        us at <span style={{ color: "#8351f9" }}>[Email Address]</span>.
                    </p>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style={{ textAlign: "center" }}>
                                    <span style={{ color: "#8351f9" }}>[YES/NO]</span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    Account login information, drivers’ licenses, health data, precise
                                    geolocation, racial or ethnic origin, religious or philosophical
                    ...
                    <ul>
                        <li>
                            Category A – <span style={{ color: "#8351f9" }}>[Retention Period]</span>
                        </li>
                        <li>
                            Category B – <span style={{ color: "#8351f9" }}>[Retention Period]</span>
                        </li>
                        <li>
                            Category C – <span style={{ color: "#8351f9" }}>[Retention Period]</span>
                        </li>
                        <li>
                            Category D – <span style={{ color: "#8351f9" }}>[Retention Period]</span>
                        </li>
                        <li>
                            Category E – <span style={{ color: "#8351f9" }}>[Retention Period]</span>
                        </li>
                        <li>
                            Category F – <span style={{ color: "#8351f9" }}>[Retention Period]</span>
                        </li>
                        <li>
                            Category G – <span style={{ color: "#8351f9" }}>[Retention Period]</span>
                        </li>
                        <li>
                            Category H – <span style={{ color: "#8351f9" }}>[Retention Period]</span>
                        </li>
                        <li>
                            Category I – <span style={{ color: "#8351f9" }}>[Retention Period]</span>
                        </li>
                        <li>
                            Category J – <span style={{ color: "#8351f9" }}>[Retention Period]</span>
                        </li>
                        <li>
                            Category K – <span style={{ color: "#8351f9" }}>[Retention Period]</span>
                        </li>
                        <li>
                            Category L – <span style={{ color: "#8351f9" }}>[Retention Period]</span>
                        </li>
                    </ul>
                    <p>
                        Category L information may be used, or disclosed to a service provider or
                        contractor, for additional, specified purposes. You have the right to limit
                    ...
                    <p>
                        <span style={{ color: "#8351f9" }}>[Company Name]</span> collects and shares
                    ...
                    <ul>
                        ...
                        <li>
                            Click redirects:{" "}
                            <span style={{ color: "#8351f9" }}>[Click Redirects]</span>
                        </li>
                        <li>
                            Social media plugins:{" "}
                            <span style={{ color: "#8351f9" }}>[Social Media Plugins]</span>. We use
                            social media features, such as a “Like” button, and widgets, such as a
                            “Share” button in our Services. Such features may process your Internet
                            Protocol (IP) address and track which page you are visiting on our
                            website. We may place a cookie to enable the feature to work correctly. If
                            you are logged in on a certain social media platform and you interact with
                            a widget or button belonging to that social media platform, this
                            information may be recorded to your profile of such social media platform.
                            To avoid this, you should log out from that social media platform before
                            accessing or using the Services. Social media features and widgets may be
                            hosted by a third party or hosted directly on our Services. Your
                            interactions with these features are governed by the privacy notices of
                            the companies that provide them. By clicking on one of these buttons, you
                            agree to the use of this plugin and consequently the transfer of personal
                            information to the corresponding social media service. We have no control
                            over the essence and extent of these transmitted data or their additional
                            processing.
                        </li>
                        <li>
                            <span style={{ color: "#8351f9" }}>[Other]</span>
                    ...
                    <p>
                        <span style={{ color: "#8351f9" }}>
                            [You can opt out from the selling or sharing of your personal information
                            by disabling cookies in Cookie Preference Settings and clicking on the Do
                            Not Sell or Share My Personal Information link on our homepage.]
                        </span>
                    </p>
                    <p>
                        You may contact us by email at{" "}
                        <span style={{ color: "#8351f9" }}>[Email Address]</span>, by calling
                        toll-free at <span style={{ color: "#8351f9" }}>[Phone Number]</span>, by
                        visiting <span style={{ color: "#8351f9" }}>[Contact Form URL]</span>, or by
                    ...
                    <p>
                        <span style={{ color: "#8351f9" }}>[Company Name]</span> has disclosed the
                        following categories of personal information to third parties for a business
                    ...
                    <ul>
                        ...
                        <li>
                            Category C. Characteristics of protected classifications under California
                        ...
                        <li>
                            ...
                            such as browsing history, search history, online behavior, interest data,
                        ...
                        <li>
                            Category J. Education information, such as student records and directory
                            information.
                        </li>
                        <li>
                        ...
                        <li>
                            Category L. Sensitive personal information, such as account login
                            information, drivers’ licenses, health data, precise geolocation, racial
                            or ethnic origin, religious or philosophical beliefs, and sex life or
                            sexual orientation.
                        </li>
                    </ul>
                    <p>
                        ...
                        <em>WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</em>“.
                    </p>
                    <p>
                        <span style={{ color: "#8351f9" }}>
                            [[Company Name] has not sold or shared any personal information to third
                            parties for a business or commercial purpose in the preceding twelve (12)
                            months. / [Company Name] has sold or shared the following categories of
                            personal information to third parties in the preceding twelve (12) months:
                        </span>
                    </p>
                    <ul>
                        <li>
                    ...
                    <ul>
                        <li>
                            <span style={{ color: "#8351f9" }}>Ad Networks</span>
                        </li>
                        <li>
                            <span style={{ color: "#8351f9" }}>Affiliate Marketing Programs</span>
                        </li>
                        <li>
                            <span style={{ color: "#8351f9" }}>Data Analytics Services</span>
                        </li>
                        <li>
                            <span style={{ color: "#8351f9" }}>Retargeting Platforms</span>
                        </li>
                        <li>
                            <span style={{ color: "#8351f9" }}>Social Networks</span>
                        </li>
                        <li>
                            <span style={{ color: "#8351f9" }}>
                    ...
                    <p>
                        <span style={{ color: "#8351f9" }}>
                            The categories of third parties to whom we shared personal information
                            with are:
                        </span>
                    </p>
                    <ul>
                    ...
                    <ul>
                        ...
                        <li>
                            the business or commercial purpose for collecting, sharing, or selling
                    ...
                    <ul>
                        <li>
                            <span style={{ color: "#8351f9" }}>
                                social security information, drivers’ licenses, state ID cards, passport
                                numbers
                            </span>
                        </li>
                        <li>
                            <span style={{ color: "#8351f9" }}>account login information</span>
                        </li>
                        <li>
                            <span style={{ color: "#8351f9" }}>
                        ...
                        <li>
                            <span style={{ color: "#8351f9" }}>precise geolocation</span>
                        </li>
                        <li>
                            <span style={{ color: "#8351f9" }}>
                    ...
                    <p>
                        <span style={{ color: "#8351f9" }}>
                            ...
                            Information, please email [Email Address] or visit: [DSAR Form URL].
                        </span>
                        ]
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        toll-free at <span style={{ color: "#8351f9" }}>[Phone Number]</span>, by
                        visiting <span style={{ color: "#8351f9" }}>[Contact Form URL]</span>, or by
                        referring to the contact details at the bottom of this document. If you have
                    ...
                    <p>
                        The law permits financial incentives or a price or service difference if it
                        is reasonably related to the value of the consumer’s data. A business must
                        be able to explain how the financial incentive or price or service
                    ...
                    <p>
                        ...
                        difference) in exchange for the retention, sale or sharing of a consumer’s
                    ...
                    <p>
                        ...
                        the categories of personal information that are implicated by the financial
                        incentive or price or service difference.
                    </p>
                    <p>
                        ...
                        <span style={{ color: "#8351f9" }}>[Email Address]</span>, by calling us
                        toll-free at <span style={{ color: "#8351f9" }}>[Phone Number]</span>, by
                        visiting <span style={{ color: "#8351f9" }}>[Contact Form URL]</span>, or by
                        referring to the contact details at the bottom of this document.
                    </p>
                    ...
                    <p>
                        Our metrics for all CCPA requests received for the previous calendar year
                        can be found here: <span style={{ color: "#8351f9" }}>[Metrics URL]</span>.
                    </p>
                    <h3>15. DO VIRGINIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</h3>
                    <p>
                        <em>
                            <strong>In Short:</strong> Yes, if you are a resident of Virginia, you may
                            be granted specific rights regarding access to and use of your personal
                            information.
                        </em>
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        on how you interact with{" "}
                        <span style={{ color: "#8351f9" }}>[Company Name]</span> and our Services.
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            effects ([“profiling”/’profiling’])
                        </li>
                    </ul>
                    <p>
                        <span style={{ color: "#8351f9" }}>
                            [[Company Name] has not sold any personal data to third parties for
                            business or commercial purposes. [Company Name] will not sell personal
                            data in the future belonging to website visitors, users, and other
                            consumers. / [Company Name] sells personal data to third parties or
                            processes personal data for targeted advertising. Please see the following
                            section to find out how you can opt out from further selling or sharing of
                    ...
                    <p>
                        You may contact us by email at{" "}
                        <span style={{ color: "#8351f9" }}>[Email Address]</span>, by visiting{" "}
                        <span style={{ color: "#8351f9" }}>[Contact Form URL]</span>, or by
                        referring to the contact details at the bottom of this document.
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        please email us at <span style={{ color: "#8351f9" }}>[Email Address]</span>
                        ...
                        appeal is denied, you may contact the Attorney General to{" "}
                        <a
                    ...
                    <p>
                        ...
                        <span style={{ color: "#8351f9" }}>[DPO Name]</span>, by email at{" "}
                        <span style={{ color: "#8351f9" }}>[Email Address]</span>, by phone at{" "}
                        <span style={{ color: "#8351f9" }}>[Phone Number]</span>, or by post to:
                    </p>
                    <p>
                        <span style={{ color: "#8351f9" }}>[Company Name]</span>
                        <br />
                        <span style={{ color: "#8351f9" }}>[DPO Name]</span>
                        <br />
                        <span style={{ color: "#8351f9" }}>[Street Address]</span>
                        <br />
                        <span style={{ color: "#8351f9" }}>[City, State ZIP Code]</span>
                        <br />
                        <span style={{ color: "#8351f9" }}>[Country]</span>
                    </p>
                    <p>
                        If you are a resident in the European Economic Area, the “data controller”
                        of your personal information is{" "}
                        <span style={{ color: "#8351f9" }}>[Company Name]</span>.{" "}
                        <span style={{ color: "#8351f9" }}>[Company Name]</span> has appointed{" "}
                        <span style={{ color: "#8351f9" }}>[EEA Representative Name]</span> to be
                        its representative in the EEA. You can contact them directly regarding the
                        processing of your information by{" "}
                        <span style={{ color: "#8351f9" }}>[Company Name]</span>, by email at{" "}
                        <span style={{ color: "#8351f9" }}>[Email Address]</span>, by visiting{" "}
                        <span style={{ color: "#8351f9" }}>[EEA Representative URL]</span>, by phone
                        at <span style={{ color: "#8351f9" }}>[Phone Number]</span>, or by post to:
                    </p>
                    <p>
                        <span style={{ color: "#8351f9" }}>[Street Address]</span>
                        <br />
                    ...
                    <p>
                        If you are a resident in the United Kingdom, the “data controller” of your
                        personal information is{" "}
                        <span style={{ color: "#8351f9" }}>[Company Name]</span>.{" "}
                        <span style={{ color: "#8351f9" }}>[Company Name]</span> has appointed{" "}
                        <span style={{ color: "#8351f9" }}>[UK Representative Name]</span> to be its
                        representative in the UK. You can contact them directly regarding the
                        processing of your information by{" "}
                        <span style={{ color: "#8351f9" }}>[Company Name]</span>, by email at{" "}
                        <span style={{ color: "#8351f9" }}>[Email Address]</span>, by visiting{" "}
                        <span style={{ color: "#8351f9" }}>[UK Representative URL]</span>, by phone
                        at <span style={{ color: "#8351f9" }}>[Phone Number]</span>, or by post to:
                    </p>
                    <p>
                        <span style={{ color: "#8351f9" }}>[Street Address]</span>
                    ...
                    <p>
                        If you have any further questions or comments, you may also contact us by
                        post at the following corporate address:
                    </p>
                    <p>
                        <span style={{ color: "#8351f9" }}>[Company Name]</span>
                        <br />
                        ...
                        <span style={{ color: "#8351f9" }}>[Country]</span>
                        <br />
                        Phone: <span style={{ color: "#8351f9" }}>[Phone Number]</span>
                        <br />
                    ...
                    <p>
                        ...
                        <span style={{ color: "#8351f9" }}>[DSAR Form URL]</span>.
                    </p>
                </>

                {/* <Accordion className="" variant='light'>
                    <AccordionItem key="1" aria-label="Données personnelles que nous collectons" title="Données personnelles que nous collectons">
                        {defaultContent}
                    </AccordionItem>

                    <AccordionItem key="2" aria-label="Comment nous utilisons ces données" title="Comment nous utilisons ces données">
                        {defaultContent}
                    </AccordionItem>

                    <AccordionItem key="3" aria-label="Les droits des utilisateurs" title="Les droits des utilisateurs">
                        {defaultContent}
                    </AccordionItem>
                </Accordion> */}
            </div>
